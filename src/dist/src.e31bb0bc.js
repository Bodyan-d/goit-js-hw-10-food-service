...
var _foodCards = _interopRequireDefault(require("./food-cards.hbs"));
...
var cardsMurkup = createCardMurkup(_menu.default);

function createCardMurkup(cards) {
  return cards.map(_foodCards.default).join('');
}

console.log(cardsMurkup);
},{"./menu.json":"menu.json","./food-cards.hbs":"food-cards.hbs"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
var b=require("node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("html",require("node_modules/parcel-bundler/src/builtins/loaders/browser/html-loader.js"));b.load([["food-cards.86f5bb33.html","food-cards.hbs"]]).then(function(){require("index.js");});
